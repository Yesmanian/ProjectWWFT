 ...
 function handleImgFileSelect(e) {
     ...
     filesArr.forEach(function(f) {
         ...
         reader.onload = function(e) {
             var html = "<a href=\"javascript:void(0);\" onclick=\"deleteImageAction("+index+")\" id=\"img_id_"+index+"\"><img src=\"" + e.target.result + "\" data-file='"+f.name+"' class='selFile' style='width:600px; height:200px;' title='Click to remove'></a>";
