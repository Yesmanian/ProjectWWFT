            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                  aria-expanded="false"> <img src="/resources/images/profile/${profile.profileImage}" width="40"
                    height="40" class="rounded-circle"> <span class="caret"></span></a>
          ...
          <div class="modal-dialog" role="document" clas>
            ...
            -->
                ...
                <div class="modal-footer modalBtnContainer-modifyEvent">
                  <button type="button" class="btn btn-primary" data-dismiss="modal" id="addEvent">등록</button>
