...
<body>
	...
	<div class="d-flex justify-content-center">
		<a href="/profile/addProfile"><img
			src="/resources/images/profile/412rXWdCJ7L.png"></a>
	...
	<!--/ Product Item -->
	<div class="d-flex justify-content-center">
		<input type="button" value="프로필 관리"
			onclick="location='/profile/updateProfileList.jsp'" /> <input
