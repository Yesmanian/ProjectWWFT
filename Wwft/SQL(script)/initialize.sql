...
CREATE SEQUENCE   "SEQ_BUCKETLIST_NO"   INCREMENT BY 1 START WITH 1 ;
   ...
   (	"TREE_NO" NUMBER(10,0) NOT NULL ENABLE, 
	"USER_ID" VARCHAR2(30) NOT NULL ENABLE, 
	"TREE_NAME" VARCHAR2(30) T NULL ENABLE, 
   ...
   (	"FOREST_NO" NUMBER(10,0) NOT NULL ENABLE, 
	...
	"FOREST_CREATE_TIME" DATE NOT NULL ENABLE,
   ...
   (	"BUCKETLIST_NO" NUMBER(10,0) NOT NULL ENABLE, 
    ...
    숲 정보
    INSERT INTO FOREST values(SEQ_FOREST_NO.nextval,'test',2,'1','1',SYSDATE,NULL,NULL,NULL);
