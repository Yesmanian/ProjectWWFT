...
comments COMMENT_WRITER컬럼 사이즈 변경	 
ALTER TABLE comments MODIFY(COMMENT_WRITER VARCHAR2(200));

post POST_WRITER 컬럼 사이즈 변경
ALTER TABLE post MODIFY(POST_WRITER VARCHAR2(200));
post 테이블 컬럼 추가
