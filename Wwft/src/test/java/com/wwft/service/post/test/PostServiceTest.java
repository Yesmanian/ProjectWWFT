...
//	@Autowired
	 ...
	 * 
	 * Assert.assertEquals("테스트테스트", post.getPostDetail()); Assert.assertEquals("1",
	 * post.getPostState()); Assert.assertEquals(2, post.getPostTreeNo());
	 * Assert.assertEquals("비트네", post.getPostWriter()); Assert.assertEquals("확인앨범",
	 * post.getAlbumName());
	 * 
	 * 
	 * 
	 ...
	 * 
	 * 
	 * Assert.assertEquals("확인중", post.getPostDetail()); Assert.assertEquals("1",
	 * post.getPostState()); Assert.assertEquals("주말", post.getAlbumName());
	 * 
	 * 
	 * 
